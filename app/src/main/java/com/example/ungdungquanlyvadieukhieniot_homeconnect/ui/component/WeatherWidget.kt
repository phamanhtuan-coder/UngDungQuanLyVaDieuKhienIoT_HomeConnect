...
fun WeatherInfo() {
    ...
    // Temp
    val iconThoiGian =
        if (isDayTime()) Icons.Filled.WbSunny else Icons.Filled.NightsStay // Ban ngày/ban đêm
    ...
    Column(
        ...
        Column(
            modifier = Modifier
                .padding(16.dp)
                .background(
                    Color.LightGray.copy(alpha = 3f), shape = RoundedCornerShape(
                        25
                    )
                ),
            ...
            Row(
                ...
                Icon(
                    ...
                    tint = Color.Gray,
                    modifier = Modifier
                        .size(if (isTablet) 80.dp else 30.dp)
...
fun WeatherWidget(icon: ImageVector, value: String, label: String, isTablet: Boolean) {
    Card(
        modifier = Modifier
            .width(if (isTablet) 240.dp else 100.dp)
            .height(if (isTablet) 100.dp else 90.dp)
            .padding(8.dp)
            .background(
                Color.Transparent,
