package com.example.ungdungquanlyvadieukhieniot_homeconnect.ui.screen.devicenotificationlist
...
/** Giao diện màn hình Thông Báo Thiết Bị (DeviceNotificationListScreen)
 * -----------------------------------------
...
// Màn hình chính để chọn giữa có thông báo và không có thông báo
@Composable
...
@Preview
@Composable
fun DeviceNotificationListScreen() {
